...
def packetize(linecfg: LineCfg, debug: bool):
    ...
    for i in range(num_files):
        ...
        total_size = filesize + ((total_num_packets+1)*8) + 40 # include the 4-byte overhead (magic + sequence number) for header packet
    ...
    total_size = filesize + ((total_num_packets+1)*8) + 40
