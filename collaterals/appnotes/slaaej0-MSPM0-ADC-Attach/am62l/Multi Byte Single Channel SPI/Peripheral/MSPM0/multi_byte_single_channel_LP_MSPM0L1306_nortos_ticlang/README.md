...
This example can be used with the multi_byte_single_channel example running on another device.
...
- No parity
- 8 bits per transfer or 16 bits per transfer - both can be configured with minor changes in the sysconfig
- MSB first
