...
4. Apply the 4 patches present in the patches folder before running the ENET FOTA example.
...
- The ENET FOTA example is compatible with the 12.00 version of the FreeRTOS SDK.
- All the 4 patches are required for the Ethernet FOTA example to work properly.
