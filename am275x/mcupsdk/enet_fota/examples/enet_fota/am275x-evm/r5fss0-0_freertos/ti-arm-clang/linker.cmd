...
MEMORY
{
    ...
    R50_0_OCRAM   (RWIX)         : ORIGIN = 0x72080000 LENGTH = 0x00250000 // 1 MB for r5fss0-0 core
    R50_1_OCRAM   (RWIX)         : ORIGIN = 0x72330000 LENGTH = 0x00010000 // 512 KB for r5fss0-1 core
    R51_0_OCRAM   (RWIX)         : ORIGIN = 0x72340000 LENGTH = 0x00010000 // 512 KB for r5fss1-0 core
    R51_1_OCRAM   (RWIX)         : ORIGIN = 0x72350000 LENGTH = 0x00010000 // 512 KB for r5fss1-1 core
    ...
    C75_0_OCRAM   (RWIX)         : ORIGIN = 0x72360000 LENGTH = 0x00010000 // 512 KB for c75ss0-0 core
    C75_1_OCRAM   (RWIX)         : ORIGIN = 0x72370000 LENGTH = 0x00010000 // 512 KB for c75ss1-0 core
